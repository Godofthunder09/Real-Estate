...
$query = "SELECT * FROM addproperty WHERE property_id = '$property_id' LIMIT 1";
...
<div class="main-content">
    ...
    <div class="property-details">
        ...
        <p><span>Price Range:</span> <?= htmlspecialchars($property['price_range']) ?></p>
            ...
            <div class="image-slider">
                <div class="slider-wrapper">
                    <?php foreach ($validImages as $img):
                        $imgPath = '/jaga/landrecordsys/uploads/' . basename($img);
                    ?>
    ...
    <a class="back-link" href="admin_properties.php">← Back to Listings</a>
</div>
