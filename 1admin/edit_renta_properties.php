...
// Fetch rent property data
$query = "SELECT * FROM addrentproperty WHERE property_id = '$property_id'";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (!empty($_FILES['new_image']['name'])) {
        $upload_dir = "/jaga/landrecordsys/rent_upload/";
    ...
    $update_query = "UPDATE addrentproperty 
                     SET phone='$phone', 
    ...
    if (mysqli_query($con, $update_query)) {
        echo "<script>alert('Rental Property updated successfully!'); window.location.href='admin_renta_properties.php';</script>";
    } else {
...
<div class="main-content">
    <div class="form-box">
        ...
        <form method="POST" enctype="multipart/form-data">
            ...
            <p class="note">Must be a valid Gmail address.</p>
            ...
            <input type="text" name="rent_price" value="<?php echo htmlspecialchars($property['rent_price']); ?>" required>

            <label>Security Deposit:</label>
            <input type="text" name="security_deposit" value="<?php echo htmlspecialchars($property['security_deposit']); ?>">

            <label>Furnishing Status:</label>
            <select name="furnishing_status" required>
                <option value="Furnished" <?php if ($property['furnishing_status']=='Furnished') echo 'selected'; ?>>Furnished</option>
                <option value="Semi-Furnished" <?php if ($property['furnishing_status']=='Semi-Furnished') echo 'selected'; ?>>Semi-Furnished</option>
                <option value="Unfurnished" <?php if ($property['furnishing_status']=='Unfurnished') echo 'selected'; ?>>Unfurnished</option>
            </select>

            <label>Availability Date:</label>
            <input type="date" name="availability_date" value="<?php echo htmlspecialchars($property['availability_date']); ?>" required>

            <label>Rental Duration:</label>
            <input type="text" name="rental_duration" value="<?php echo htmlspecialchars($property['rental_duration']); ?>" required>

            <div class="btn-container">
                <button type="submit" class="btn btn-update">Update Property</button>
                <a href="admin_renta_properties.php" class="btn btn-back">Back to Properties</a>
            </div>
        </form>
    </div>
</div>
