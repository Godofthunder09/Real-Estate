...
// Get property type distribution (Rent Properties)
$query1 = "SELECT property_type, COUNT(*) as count FROM addrentproperty GROUP BY property_type";
...
// Get top uploading users
$query2 = "SELECT email, COUNT(*) as uploads FROM addrentproperty GROUP BY email ORDER BY uploads DESC LIMIT 10";
...
<head>
    <meta charset="UTF-8">
    <title>Admin Rent Analytics</title>
...
<div class="main-content">
    <div class="chart-container">
        <h3>Rent Property Types (Pie Chart)</h3>
        <canvas id="propertyPieChart"></canvas>
    </div>

    <div class="chart-container">
        <h3>Top Users Uploading Rent Properties (Bar Graph)</h3>
