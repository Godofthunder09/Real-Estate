    ...
    <table>
        ...
        <?php while ($row = mysqli_fetch_assoc($result)) { ?>
            <tr>
                ...
                <td>
                    <div class="actions">
                        <a href="view_properties.php?id=<?= urlencode($row['property_id']) ?>" class="btn btn-view">View</a>
                        <a href="edit_property.php?id=<?= urlencode($row['property_id']) ?>" class="btn btn-edit">Edit</a>
                        <a href="delete_property.php?id=<?= urlencode($row['property_id']) ?>" class="btn btn-delete" onclick="return confirm('Are you sure you want to delete this property?');">Delete</a>
                    </div>
                </td>
            </tr>
        <?php } ?>
